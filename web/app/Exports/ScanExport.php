    ...
    */
    public function collection()
    {
    	$data = DB::table('presences')
                ->selectRaw("users.id, users.reg_number, users.email, users.phone, users.name,group_concat( concat(presences.via, ' / ', presences.via_info,' / ',presences.created_at)) as info, count(users.id)")
